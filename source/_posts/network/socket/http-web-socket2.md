...
![webSocket](./http-web-socket2/websocket-1-1.jpg)
示例代码实现如下：
...
- 优点：可以看到实现非常简单，它的**兼容性**也比较好的只要**支持 http 协议**就可以用这种方式实现。
...
![webSocket](./http-web-socket2/websocket-1-2.jpg)
客户端的代码如下：
...
效果如下：
![webSocket](./http-web-socket2/websocket-1-3.gif)
...
运行效果如下：
![webSocket](./http-web-socket2/web-socket-1-2.png)
